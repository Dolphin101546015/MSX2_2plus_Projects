...
Изменения v7.0:
Новая опция позволяет отображать декодирование данных шаблона с помощью:
- Десятичного представления (нажатием [BackSpace])
- Шестнадцатеричного представления (нажатием [SHIFT]+[BackSpace])
Режим 8x8 изменен для лучшего управления и обработки банков:
- [0] позволяет изменить видимый банк из обоих редактируемых банков фонта.
Функция свапа Системного и редактируемого фонта:
- [SHIFT]+[S] меняет местами фонты в видеопамяти
Функция контура:
- Аутлайн текущего символа в линзе, нажатием [CTRL]+[O] 
Интегрированы часики:
- В правом верхнем углу отображается системное время.
Изменена нумерация битов линзы:
- Исправлена ​​нумерация битов в окне линзы.
[Del] больше не используется:
— Изменено на [SHIFT]+[Del] с функцией CUT (запоминание данных в буфер).
Изменены клавиши копирования символов из Системного фонта в редактируемый:
- на [G] для символа, и [SHIFT]+[G] для всего фонта
Улучшена задержка при рисовании (была слишком быстрой):
- изменена функция синхронизации для обоих видеорежимов (PAL/NTSC), переписан код вывода линзы
Рефакторинг кода для уменьшения размера и применения новых функции.
